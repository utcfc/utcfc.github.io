...
* The site is rendered using [quarto](https://quarto.org/), an open-source package for rendering scientific/technical writing. Everything is written in [markdown](https://en.wikipedia.org/wiki/Markdown), which you may be familiar with already through Jupyter notebooks.
