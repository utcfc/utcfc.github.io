...
If you're editing in VS Code, the quarto [extension](https://marketplace.visualstudio.com/items?itemName=quarto.quarto) can do the same thing, but integrated into your editor. It also provides markdown syntax highlighting/linting, shortcuts for running code inline, and more.
