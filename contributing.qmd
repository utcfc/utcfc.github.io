...
6. **Cite & Link Out the Wazoo**: When adding new information, always cite your sources. 
...
To fork the repo, bavigate to the `utcfc.github.io` [Github repository](https://github.com/utcfc/utcfc.github.io). 
...
::: {.callout-tip}
Quarto provides a number of features to facilitate scientific/technical writing. 
Full LaTeX support. 
Code blocks include syntax highlighting for various languages, and can even be run inline to display the output directly in the document. 
...
From within the `utcfc.github.io` directory, the command 
```sh
quarto preview
```
...
If you're editing in VS Code, the quarto [extension](https://marketplace.visualstudio.com/items?itemName=quarto.quarto) can do the same thing, but integrated into your editor. It also provides syntax highlighting, shortcuts for running code inline, and more.



## Push your edits 

Once you've made your edits, you'll want to push them to the remote repository. 
